...
class robotKinematics:
    def __init__(self):
        ...
        """in meter """
        self.L     = 0.26  #length of robot joints0.11165 
        self.W     = 0.061  #width of robot joints 0.064
        self.coxa  = 0.0305 #coxa length 0.0375
        self.femur = 0.13   #femur length
        self.tibia = 0.13813664159   #tibia length #0.2
    ...
    def solve(self, orn , pos , bodytoFeet):
        ...
        _bodytoFR0 = geometrics.transform1(self.bodytoFR0 , orn, pos)
        _bodytoFL0 = geometrics.transform1(self.bodytoFL0 , orn, pos)
        _bodytoBR0 = geometrics.transform1(self.bodytoBR0 , orn, pos)
        _bodytoBL0 = geometrics.transform1(self.bodytoBL0 , orn, pos)
        ...
        print(FRcoord, BRcoord,'coord')
        """undo transformation of leg vector to keep feet still"""
        undoOrn = -orn
        undoPos = -pos
        _FRcoord = geometrics.transform1(FRcoord , undoOrn, undoPos)
        _FLcoord = geometrics.transform1(FLcoord , undoOrn, undoPos)
        _BRcoord = geometrics.transform1(BRcoord , undoOrn, undoPos)
        _BLcoord = geometrics.transform1(BLcoord , undoOrn, undoPos)
        
        print(_FRcoord,_BRcoord,'coord2')
